<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent">
  <form method="post" action="<?php echo U('Role/add');?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
  ...
  <input type="hidden" name="pid" value="<?php echo ($id); ?>" />
    <div class="pageFormContent" layoutH="56">
      <dl>
        <dt>角色名称：</dt>
        <dd>
          <input name="name" class="required" type="text" size="30" alt="请输入角色名称" />
        </dd>
      </dl>
