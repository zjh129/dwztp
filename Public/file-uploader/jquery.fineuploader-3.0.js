...
qq.FineUploaderBasic = function(o){
    ...
    this._options = {
		...
		messages: {
            typeError: "{file} 是无效文件. 有效文件后缀是: {extensions}.",
            sizeError: "{file} 文件太大,上传文件最大为 {sizeLimit}.",
            minSizeError: "{file} 文件太小, 最小尺寸为 {minSizeLimit}.",
            emptyError: "{file} 上传文件为空, 请重新选择文件.",
            noFilesError: "没有文件被上传.",
            onLeave: "该文件正在上传，如果你现在离开上传将被取消。"
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
